...
const users = [
  ...
  { phone: "+998900000002", name: "Оператор Сеул", role: "operator" as const, clientCode: "PG-000002", city: "Сеул" },
  { phone: "+998900000003", name: "Оператор Ташкент", role: "operator" as const, clientCode: "PG-000003", city: "Ташкент" },
